...
public class SpGetNoticeContentsList extends SpSquarePlusOpenApiEx {

	public SpGetNoticeContentsList(Context context) {
		super(context);
	}

	@Override
	protected String getOpenApiPath() {
		return "/square/getNoticeContentsList.do";
	}
