...
public class SpFolderSquareListCallBack extends SpSquarePlusDefaultAjaxCallBack<SpFolderSquareVO> {
	public List<SpFolderSquareVO> dataList;
	public int totalCount = 0;
	public int pageSize = 0;
	public int pageNum = 0;
	public String lastViewId = "";

	public SpFolderSquareListCallBack(Activity a, Class<SpFolderSquareVO> cls) {
		super(a, cls);
	}
