...
import com.hs.mobile.gw.view.pulltorefresh.configuration.xml.PullToRefreshXmlConfiguration;
import com.hs.mobile.gw.view.pulltorefresh.library.internal.LoadingLayout;
import com.hs.mobile.gw.view.pulltorefresh.library.internal.Utils;
import com.hs.mobile.gw.view.pulltorefresh.library.internal.ViewCompat;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	...
	protected void onReset() {
		...
		if (mMode.showGoogleStyle()) {
			...
			if ( mRefreshing&& mRefeshableViewHideWhileRefreshingEnabled ) {
	...
	protected final void refreshLoadingViewsSize() {
		...
		switch (getFilteredPullToRefreshScrollDirection()) {
			...
			case VERTICAL:
				if (mMode.showHeaderLoadingLayout()) {
				...
				} else if (mMode.showGoogleStyle() && mWindowAttached) {
					/**
					 ...
					 */
					if (mSetGoogleViewLayoutSizeToActionbarHeight) {
	...
	private void showViewTopLayout() {
    	...
    	if ( mShowGoogleStyleViewAnimationEnabled  ) {
