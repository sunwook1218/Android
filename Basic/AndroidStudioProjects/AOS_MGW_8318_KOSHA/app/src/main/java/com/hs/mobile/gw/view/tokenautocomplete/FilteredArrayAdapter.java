...
abstract public class FilteredArrayAdapter<T> extends ArrayAdapter<T> {
	...
	/**
	 * Filter method used by the adapter. Return true if the object should
	 * remain in the list
	 * 
	 * @param obj
	 *            object we are checking for inclusion in the adapter
	 * @param mask
	 *            current text in the edit text we are completing against
