...
public class SpGetWorkfeedPopularTagList extends SpSquarePlusOpenApiEx {

	public SpGetWorkfeedPopularTagList(Context context) {
		super(context);
	}

	@Override
	protected String getOpenApiPath() {
		return "/square/getWorkfeedPopularTagList.do";
	}
