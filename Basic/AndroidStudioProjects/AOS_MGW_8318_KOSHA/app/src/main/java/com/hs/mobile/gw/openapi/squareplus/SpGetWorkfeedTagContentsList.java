...
public class SpGetWorkfeedTagContentsList extends SpSquarePlusOpenApiEx {

	public SpGetWorkfeedTagContentsList(Context context) {
		super(context);
	}

	@Override
	protected String getOpenApiPath() {
		return "/square/getWorkfeedTagContentsList.do";
	}
