...
public class SpUpdateFolderMySquareMenu extends SpSquarePlusOpenApiEx {
	public SpUpdateFolderMySquareMenu(Context context) {
		super(context);
	}

	@Override
	protected String getOpenApiPath() {
		return "/square/updateFolderMySquareMenu.do";
	}
