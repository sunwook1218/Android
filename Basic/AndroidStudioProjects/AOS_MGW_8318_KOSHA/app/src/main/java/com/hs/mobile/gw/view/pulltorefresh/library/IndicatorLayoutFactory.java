...
import com.hs.mobile.gw.view.pulltorefresh.library.internal.DefaultIndicatorLayout;
import com.hs.mobile.gw.view.pulltorefresh.library.internal.IndicatorLayout;
...
public class IndicatorLayoutFactory {
	 ...
	 * @param clazzName Class name such as "com.hs.mobile.gw.view.pulltorefresh.library.internal.DefaultIndicatorLayout"
	...
	private static IndicatorLayout tryNewInstance(
		...
		try {
			...
			layout = constructor.newInstance(context, mode);
