 ...
 *******************************************************************************/
package com.hs.mobile.gw.view.pulltorefresh.configuration.xml;
...
import com.hs.mobile.gw.view.pulltorefresh.library.internal.Assert;
...
public class PullToRefreshXmlConfiguration {
	 ...
	 * @return Layout Class name ( ex: com.hs.mobile.gw.view.pulltorefresh.library.internal.FlipLoadingLayout )
	 */
	...
	/**
	 * @param layoutCode Layout name
	 * @return Layout Class name ( ex: com.hs.mobile.gw.view.pulltorefresh.library.internal.DefaultLoadingLayout )
	 */
	...
	/**
	 * @param layoutCode Layout name
	 * @return Layout Class name ( ex: com.hs.mobile.gw.view.pulltorefresh.library.internal.DefaultGoogleStyleViewLayout )
	 */
	...
	/**
	 * @param layoutCode Layout name
	 * @return Layout Class name ( ex: com.hs.mobile.gw.view.pulltorefresh.library.internal.DefaultGoogleStyleProgressLayout )
	 */
