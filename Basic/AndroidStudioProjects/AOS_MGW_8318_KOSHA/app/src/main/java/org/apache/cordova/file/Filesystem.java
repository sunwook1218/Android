...
public abstract class Filesystem {
    ...
    public static JSONObject makeEntryForURL(LocalFilesystemURL inputURL, Uri nativeURL) {
        try {
            ...
            if (inputURL !=null && inputURL.isDirectory && !nativeUrlStr.endsWith("/")) {
                nativeUrlStr += "/";
            }
    ...
    protected static String normalizePath(String rawPath) {
        ...
        boolean isAbsolutePath = rawPath.charAt(0) == '/';
        if (isAbsolutePath) {
	...
	public JSONObject getParentForLocalURL(LocalFilesystemURL inputURL) throws IOException {
        ...
        if(LocalFilesystemURL.parse(parentUri)==null) return null;
