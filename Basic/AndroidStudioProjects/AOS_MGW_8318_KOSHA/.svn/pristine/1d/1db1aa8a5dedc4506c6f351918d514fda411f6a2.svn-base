...
public class SpTagListCallBack extends SpSquarePlusDefaultAjaxCallBack<SpTagVO> {
	public List<SpTagVO> dataList = new ArrayList<SpTagVO>();
	public int totalCount = 0;
	public int pageSize = 0;
	public int pageNum = 0;
	public String lastViewId = "";

	public SpTagListCallBack(Activity a, Class<SpTagVO> cls) {
		super(a, cls);
	}
