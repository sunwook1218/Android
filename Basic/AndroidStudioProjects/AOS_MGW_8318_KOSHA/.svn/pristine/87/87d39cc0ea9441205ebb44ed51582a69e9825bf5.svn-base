...
public class SpUserSettingsListCallBack extends SpSquarePlusDefaultAjaxCallBack<SpUserSettingsVO> {
	public List<SpUserSettingsVO> dataList;
	public int totalCount = 0;
	public int pageSize = 0;
	public int pageNum = 0;
	public String lastViewId = "";

	public SpUserSettingsListCallBack(Activity a, Class<SpUserSettingsVO> cls) {
		super(a, cls);
	}
