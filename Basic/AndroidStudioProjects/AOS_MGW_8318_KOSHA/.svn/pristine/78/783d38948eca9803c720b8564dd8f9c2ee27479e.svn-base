...
import com.hs.mobile.gw.fragment.square.file.SquareFileModel.FileType;
import com.hs.mobile.gw.fragment.square.file.SquareFileModel.ISquareFileResultListener;
...
public class SquareFileController extends CommonFragmentController<SquareFileFragment, SquareFileModel> implements OnClickListener,
		IBookmarkAndOptionViewListener, OnItemClickListener, OnRefreshListener<ListView>, OnLastItemVisibleListener
// ,IChangeContentsListener
{
	private String m_strSelectedUserId;

	public SquareFileController(SquareFileFragment view, SquareFileModel model) {
		super(view, model);
	}
	...
	public void setFilter(FileFilter t) {
