...
public class SpMoveFolderMySquareMenu extends SpSquarePlusOpenApiEx {
	public SpMoveFolderMySquareMenu(Context context) {
		super(context);
	}

	@Override
	protected String getOpenApiPath() {
		return "/square/moveFolderMySquareMenu.do";
	}
