...
public class SpAddFolderMySquareMenu extends SpSquarePlusOpenApiEx {
	public SpAddFolderMySquareMenu(Context context) {
		super(context);
	}

	@Override
	protected String getOpenApiPath() {
		return "/square/addFolderMySquareMenu.do";
	}
