...
import com.hs.mobile.gw.view.pulltorefresh.library.PullToRefreshBase.OnPullEventListener;
import com.hs.mobile.gw.view.pulltorefresh.library.PullToRefreshBase.OnRefreshListener;
import com.hs.mobile.gw.view.pulltorefresh.library.PullToRefreshBase.OnRefreshListener2;
import com.hs.mobile.gw.view.pulltorefresh.library.PullToRefreshBase.State;
