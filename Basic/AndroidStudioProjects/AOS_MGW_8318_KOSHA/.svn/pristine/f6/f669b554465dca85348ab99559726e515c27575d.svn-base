 ...
 *
 */
public class SpContentsMentionListCallBack extends SpSquarePlusDefaultAjaxCallBack<SpContentsMentionVO> {
	public List<SpContentsMentionVO> dataList;
	public int totalCount = 0;
	public int pageSize = 0;
	public int pageNum = 0;
	public String lastViewId = "";

	public SpContentsMentionListCallBack(Activity a, Class<SpContentsMentionVO> cls) {
		super(a, cls);
	}
