...
public class SpGetWorkfeedContentsList extends SpSquarePlusOpenApiEx {

	public SpGetWorkfeedContentsList(Context context) {
		super(context);
	}

	@Override
	protected String getOpenApiPath() {
		return "/square/getWorkfeedContentsList.do";
	}
